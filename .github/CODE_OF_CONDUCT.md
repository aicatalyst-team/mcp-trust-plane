...
Tensions can occur between community members even when they are trying their best to collaborate. Not every conflict represents a Code of Conduct violation. This document reinforces behaviors that help avoid conflict and minimize harm.
...
Moderators aim to balance **transparency, safety, and confidentiality**. Enforcement actions are handled privately, though broader communication may occur if part of a resolution.

---

## Addressing and Repairing Harm

If a violation is confirmed, the following enforcement ladder may be used. Severity may cause steps to be skipped.
...
This ladder is a guideline and does not limit moderator discretion.
